...
public class NotificationUtils {
    ...
    public static void remindUserBecauseCharging(Context context) {
        ...
        NotificationCompat.Builder notif = new NotificationCompat.Builder(context, WATER_REMINDER_NOTIFICATION_CHANNEL_ID)
        ...
        notificationManager.notify(WATER_REMINDER_NOTIFICATION_ID, notif.build());
    }
